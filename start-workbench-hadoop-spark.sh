...
docker-compose -f docker-compose.yml up -d build namenode datanode spark-master spark-worker spark-notebook 

# Start the Docker containers
echo "Starting Docker containers..."

docker-compose -f docker-compose.yml up -d postgres namenode datanode spark-master spark-worker spark-notebook

# Check the status of the Docker containers
echo "Checking the status of Docker containers..."
docker-compose -f docker-compose.yml up -d ps
